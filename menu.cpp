...
void game_maker() // 제작자 함수
{
   systemcls(); // 왼쪽 틀 안에 공백 씌우기
   gotoxy(8, 4);
   printf("한남대학교 컴퓨터공학과 2학년");
   gotoxy(9, 6);
   printf("프로그래밍 응용 02분반<2조>");
   gotoxy(11, 12);
   printf("조장: 20110751 최현우");
   gotoxy(11, 14);
   printf("조원: 20110748 윤봉현");
   gotoxy(11, 16);
   printf("조원: 20112728 김량훈");
   gotoxy(11, 18);
   printf("조원: 20110739 정찬호");
   gotoxy(4, 21);
   printf("메뉴로 돌아가기: M\n\n\n");
   arrow=getch();
   if(arrow==109) // m키를 누를시
